...
import DocsReducer from './allDocs';
import currentDocReducer from './currentDoc';
...
const initialState = {
  ...
  get currentDoc() {
    const doc = localStorage.getItem('currentDoc') ? JSON.parse(localStorage.getItem('currentDoc')) : this.docs[0];
    return doc;
  },
